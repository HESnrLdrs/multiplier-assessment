...
function displayResults(scores, reds) {
    ...
    // Add Back to Dashboard button at the bottom
    content += `
        <div style="text-align: center; margin-top: 60px; margin-bottom: 40px; padding-top: 40px; border-top: 2px solid #e0e0e0;">
            <a href="/" style="display: inline-block; padding: 15px 40px; background: #667eea; color: white; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 1.1em; box-shadow: 0 4px 6px rgba(102, 126, 234, 0.3);">
                ← Back to Dashboard
            </a>
        </div>
    `;
...
function getWorkbookRecommendation(scores, reds) {
    ...
    // No reds - check if all amber or mixed
    const allGreen = scores.motivation >= 7.0 && scores.learning >= 7.0 && scores.identity >= 7.0;
    const allAmber = scores.motivation >= 5.0 && scores.motivation < 7.0 && 
                     scores.learning >= 5.0 && scores.learning < 7.0 && 
                     scores.identity >= 5.0 && scores.identity < 7.0;
    
    if (allAmber) {
        // All amber - recommend Momentum Workbook
        return {
            type: 'momentum',
            primary: 'momentum',
            secondary: null,
            message: 'You have workable capacity across all dimensions, but improvement in each area would significantly increase your overall capacity. The Momentum Workbook helps you build on what you have and move from workable to strong.'
        };
    } else if (allGreen) {
        // True all green - recommend coaching for direction
        return {
            type: 'all-green',
            primary: null,
            secondary: null,
        ...
        // Mixed green/amber - recommend Momentum Workbook
        return {
            type: 'momentum',
            primary: 'momentum',
            secondary: null,
            message: 'You have genuine strengths to build on and clear areas to improve. The Momentum Workbook helps you leverage your green dimensions to strengthen your amber areas.'
        };
    }
}
...
function generateMultipleRedsContent(reds, scores) {
    ...
    // Check if all three are red (crisis scenario)
    const isCrisis = reds.length === 3;
    ...
    return `
        ...
        <div class="results-content">
            ...
            <section class="micro-action">
                <h2>What To Do Right Now</h2>
                <p><strong>The most important thing you can do is reach out for support.</strong></p>
                
                <div class="exercise-box">
                    <h3>Your Next Step</h3>
                    <p>With all three dimensions in red, trying to figure this out alone isn't the answer. Book a free results review call and we'll work together to create a support plan that makes sense for your situation.</p>
                    <p><strong>You don't have to do this alone. That's it. Just book the call.</strong></p>
                </div>
            </section>
            `}
...
// ============================================
// ALL GREEN CONTENT (NO REDS)
// Now with scenario differentiation
// ============================================

function generateAllGreenContent(scores) {
    // Determine exact scenario
    const allGreen = scores.motivation >= 7.0 && scores.learning >= 7.0 && scores.identity >= 7.0;
    const allAmber = scores.motivation >= 5.0 && scores.motivation < 7.0 && 
                     scores.learning >= 5.0 && scores.learning < 7.0 && 
                     scores.identity >= 5.0 && scores.identity < 7.0;
    ...
    if (allGreen) {
        return generateTrueAllGreenContent(scores);
    } else if (allAmber) {
        return generateAllAmberContent(scores);
    } else {
        return generateMixedGreenAmberContent(scores);
    }
}

// TRUE ALL GREEN - High capacity, needs direction
function generateTrueAllGreenContent(scores) {
    return `
        <div class="results-header">
...
// ALL AMBER - Workable capacity, needs momentum
function generateAllAmberContent(scores) {
    return `
        <div class="results-header">
            <h1>Your Results: Workable Capacity</h1>
            ${generateScoresHTML(scores)}
            <p class="constraint-label">Status: <strong>Development Opportunities</strong></p>
        </div>
        
        <div class="results-content">
            <section class="what-this-means">
                <h2>What This Means</h2>
                <p>You have workable capacity across all three dimensions. <strong>You're not stuck, but you could be stronger.</strong></p>
                
                <p>All three areas - Motivation, Learning, and Identity - are at amber level. This means you can function, but improvement in each area would significantly increase your overall capacity.</p>
                
                <p>The good news: <strong>You don't have crisis-level constraints. You have development opportunities.</strong></p>
            </section>
            
            <section class="why-matters">
                <h2>Why This Matters</h2>
                <p>Because the M×L×I framework is multiplicative, improving any dimension has a compounding effect on your overall capacity.</p>
                
                <p>For example, if you moved each dimension from amber (5-6) to green (7+):</p>
                <ul>
                    <li>Your Motivation increases clarity and drive</li>
                    <li>Your Learning improves confidence in new skills</li>
                    <li>Your Identity strengthens sense of self</li>
                    <li>Together, your capacity could more than double</li>
                </ul>
            </section>
            ...
            <section class="micro-action">
                ...
                <div class="exercise-box">
                    <h3>The One Percent Better Exercise</h3>
                    <p>Pick ONE dimension (M, L, or I) and identify one small improvement:</p>
                    <ol>
                        <li>What's one small thing that would make this dimension slightly stronger?</li>
                        <li>When could you do it this week?</li>
                        <li>How will you know it worked?</li>
                    </ol>
                    <p><strong>That's it. Just identify one small improvement today.</strong></p>
                </div>
            </section>
...
// MIXED GREEN/AMBER - Partial strengths, targeted development
function generateMixedGreenAmberContent(scores) {
    // Identify which are green and which are amber
    const greens = [];
    const ambers = [];
    
    if (scores.motivation >= 7.0) greens.push('Motivation');
    else if (scores.motivation >= 5.0) ambers.push('Motivation');
    
    if (scores.learning >= 7.0) greens.push('Learning');
    else if (scores.learning >= 5.0) ambers.push('Learning');
    
    if (scores.identity >= 7.0) greens.push('Identity');
    else if (scores.identity >= 5.0) ambers.push('Identity');
    
    const greenText = greens.length > 0 ? greens.join(' and ') : '';
    const amberText = ambers.length > 0 ? ambers.join(' and ') : '';
    
    return `
        <div class="results-header">
            <h1>Your Results: Partial Strengths</h1>
            ${generateScoresHTML(scores)}
            <p class="constraint-label">Strengths: <strong>${greenText}</strong> | Development: <strong>${amberText}</strong></p>
        </div>
        
        <div class="results-content">
            <section class="what-this-means">
                <h2>What This Means</h2>
                <p>You have a mixed profile: <strong>${greenText} ${greens.length > 1 ? 'are' : 'is'} strong, while ${amberText} ${ambers.length > 1 ? 'need' : 'needs'} development.</strong></p>
                
                <p>This is actually quite common and represents real opportunity. You have genuine strengths to build on, and clear areas to improve.</p>
            </section>
            
            <section class="why-matters">
                <h2>Why This Matters</h2>
                <p>Your green dimensions give you a foundation to work from. Strengthening your amber ${ambers.length > 1 ? 'areas' : 'area'} will significantly increase your overall capacity.</p>
                
                <p><strong>Focus on moving ${amberText} from amber to green.</strong> Because the framework is multiplicative, this will have a compounding effect on your capacity.</p>
            </section>
            ...
            <section class="micro-action">
                ...
                <div class="exercise-box">
                    <h3>The Leverage Exercise</h3>
                    <p>Focus on your amber ${ambers.length > 1 ? 'dimensions' : 'dimension'} (${amberText}):</p>
                    <ol>
                        <li>How could you use your strength in ${greenText} to help develop ${amberText}?</li>
                        <li>What's one small action you could take this week?</li>
                        <li>Who could support you with this?</li>
                    </ol>
                    <p><strong>That's it. Just think about leveraging your strengths today.</strong></p>
                </div>
            </section>
        ...
        sections: [{
            children: [
                ...
                new Paragraph({
                    ...
                    spacing: { after: 300 },
                    children: [new TextRun({ text: "NAVIGATING TRANSITION REPORT", bold: true, size: 56, color: "1F4788" })]
                }),
                    ...
                    rows: [
                            ...
                            children: [
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ text: "Dimension", bold: true, size: 26, color: "2c3e50" })]
                                    })],
                                    width: { size: 25, type: WidthType.PERCENTAGE }
                                }),
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ text: "Score", bold: true, size: 26, color: "2c3e50" })]
                                    })],
                                    width: { size: 25, type: WidthType.PERCENTAGE }
                                }),
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ text: "Status", bold: true, size: 26, color: "2c3e50" })]
                                    })],
                                    width: { size: 25, type: WidthType.PERCENTAGE }
                                }),
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ text: "Assessment", bold: true, size: 26, color: "2c3e50" })]
                                    })],
                                    width: { size: 25, type: WidthType.PERCENTAGE }
                                })
                            ]
                        ...
                        new TableRow({
                            children: [
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ text: "MOTIVATION", bold: true, size: 24, color: "1F4788" })]
                                    })]
                                }),
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ text: `${scores.motivation.toFixed(1)}/10`, size: 24, color: "34495e" })]
                                    })]
                                }),
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ 
                                            text: getTrafficLightText(scores.motivation), 
                                            bold: true, 
                                            size: 24, 
                                            color: getTrafficLightColor(scores.motivation) 
                                        })]
                                    })]
                                }),
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ 
                                            text: getAssessment(scores.motivation), 
                                            bold: true, 
                                            size: 24, 
                                            color: getAssessmentColor(scores.motivation) 
                                        })]
                                    })]
                                })
                            ]
                        ...
                        new TableRow({
                            children: [
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ text: "LEARNING", bold: true, size: 24, color: "2E5C8A" })]
                                    })]
                                }),
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ text: `${scores.learning.toFixed(1)}/10`, size: 24, color: "34495e" })]
                                    })]
                                }),
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ 
                                            text: getTrafficLightText(scores.learning), 
                                            bold: true, 
                                            size: 24, 
                                            color: getTrafficLightColor(scores.learning) 
                                        })]
                                    })]
                                }),
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ 
                                            text: getAssessment(scores.learning), 
                                            bold: true, 
                                            size: 24, 
                                            color: getAssessmentColor(scores.learning) 
                                        })]
                                    })]
                                })
                            ]
                        ...
                        new TableRow({
                            children: [
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ text: "IDENTITY", bold: true, size: 24, color: "4A7BA7" })]
                                    })]
                                }),
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ text: `${scores.identity.toFixed(1)}/10`, size: 24, color: "34495e" })]
                                    })]
                                }),
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ 
                                            text: getTrafficLightText(scores.identity), 
                                            bold: true, 
                                            size: 24, 
                                            color: getTrafficLightColor(scores.identity) 
                                        })]
                                    })]
                                }),
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ 
                                            text: getAssessment(scores.identity), 
                                            bold: true, 
                                            size: 24, 
                                            color: getAssessmentColor(scores.identity) 
                                        })]
                                    })]
                                })
                            ]
                ...
                // Step 2 - only show if NOT crisis (not all red)
                ...(reds.length !== 3 ? [
                    new Paragraph({
                        spacing: { after: 150 },
                        children: [
                ...
                new Paragraph({
                    spacing: { after: 300 },
                    children: [
                        new TextRun({ text: reds.length === 3 ? "2. " : "3. ", bold: true, size: 26, color: "667eea" }),
                ...
                new Paragraph({
                    spacing: { after: 100 },
                    children: [new TextRun({ text: "Paul Thomas Coaching", bold: true, size: 24, color: "1F4788" })]
                }),
                new Paragraph({
                    spacing: { after: 80 },
                ...
                new Paragraph({
                    alignment: AlignmentType.CENTER,
                    spacing: { before: 400 },
                    children: [new TextRun({ text: "© 2025 Paul Thomas Coaching. All rights reserved.", size: 22, color: "7f8c8d", italics: true })]
                })
            ]
        }]
    });
