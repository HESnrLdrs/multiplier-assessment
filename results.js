...
async function generateAndDownloadReport(scores, reds) {
    ...
    // Create document
    // Create document with simple, reliable formatting
        ...
        sections: [{
            children: [
                ...
                new Paragraph({
                    ...
                    children: [new TextRun({ text: userName, bold: true, size: 32, color: "1F4788" })]
                }),
                new Paragraph({
                    alignment: AlignmentType.CENTER,
                    spacing: { after: 100 },
                    children: [new TextRun({ text: userEmail, size: 22 })]
                }),
                new Paragraph({
                    alignment: AlignmentType.CENTER,
                    spacing: { after: 600 },
                    children: [new TextRun({ text: `Assessment Date: ${assessmentDate}`, size: 20, italics: true })]
                }),
                ...
                new Paragraph({
                    alignment: AlignmentType.CENTER,
                    spacing: { before: 400, after: 200 },
                    children: [new TextRun({ text: "YOUR CAPACITY SCORE", bold: true, size: 28 })]
                }),
                new Paragraph({
                    alignment: AlignmentType.CENTER,
                    spacing: { after: 100 },
                    children: [new TextRun({ text: scores.capacityScore.toString(), bold: true, size: 72, color: "667eea" })]
                }),
                new Paragraph({
                    alignment: AlignmentType.CENTER,
                    spacing: { after: 400 },
                    children: [new TextRun({ text: `M×L×I = ${scores.motivation.toFixed(1)} × ${scores.learning.toFixed(1)} × ${scores.identity.toFixed(1)}`, size: 24 })]
                }),
                ...
                new Paragraph({
                    ...
                    children: [
                        new TextRun({ text: "Primary Constraint: ", size: 24 }),
                        new TextRun({ text: constraintText, bold: true, size: 24, color: "e74c3c" })
                    ]
                }),
                ...
                new Paragraph({
                    ...
                    children: [new TextRun({ text: "DETAILED DIMENSIONAL SCORES", bold: true, size: 28 })]
                }),
                ...
                new Paragraph({
                    spacing: { after: 100 },
                    children: [
                        new TextRun({ text: `Score: ${scores.motivation.toFixed(1)}/10    `, size: 22 }),
                        new TextRun({ text: `Status: ${getTrafficLight(scores.motivation)}    `, size: 22 }),
                        new TextRun({ text: `Assessment: ${getAssessment(scores.motivation)}`, size: 22 })
                    ]
                }),
                ...
                new Paragraph({
                    spacing: { after: 100 },
                    children: [
                        new TextRun({ text: `Score: ${scores.learning.toFixed(1)}/10    `, size: 22 }),
                        new TextRun({ text: `Status: ${getTrafficLight(scores.learning)}    `, size: 22 }),
                        new TextRun({ text: `Assessment: ${getAssessment(scores.learning)}`, size: 22 })
                    ]
                }),
                ...
                new Paragraph({
                    spacing: { after: 400 },
                    children: [
                        new TextRun({ text: `Score: ${scores.identity.toFixed(1)}/10    `, size: 22 }),
                        new TextRun({ text: `Status: ${getTrafficLight(scores.identity)}    `, size: 22 }),
                        new TextRun({ text: `Assessment: ${getAssessment(scores.identity)}`, size: 22 })
                    ]
                }),
                ...
                new Paragraph({
                    ...
                    children: [new TextRun({ text: "UNDERSTANDING THE M×L×I FRAMEWORK", bold: true, size: 28 })]
                }),
                new Paragraph({
                    spacing: { after: 400 },
                    children: [new TextRun({ text: "The M×L×I assessment measures three dimensions that determine your readiness for career transition. These dimensions work together multiplicatively - meaning that weakness in any one area constrains your overall capacity.", size: 22 })]
                }),
                
                // M
                new Paragraph({
                    spacing: { before: 200, after: 100 },
                    children: [new TextRun({ text: "MOTIVATION (M)", bold: true, size: 24, color: "1F4788" })]
                }),
                new Paragraph({
                    spacing: { after: 300 },
                    children: [new TextRun({ text: "Your drive and commitment to making the transition happen", size: 22 })]
                }),
                
                // L
                new Paragraph({
                    spacing: { before: 200, after: 100 },
                    children: [new TextRun({ text: "LEARNING (L)", bold: true, size: 24, color: "2E5C8A" })]
                }),
                new Paragraph({
                    spacing: { after: 300 },
                    children: [new TextRun({ text: "Your readiness and capability to acquire new skills and adapt to new roles", size: 22 })]
                }),
                
                // I
                new Paragraph({
                    spacing: { before: 200, after: 100 },
                    children: [new TextRun({ text: "IDENTITY (I)", bold: true, size: 24, color: "4A7BA7" })]
                }),
                new Paragraph({
                    spacing: { after: 600 },
                    children: [new TextRun({ text: "Your clarity about who you are professionally and who you're becoming", size: 22 })]
                }),
                
                // === NEXT STEPS ===
                new Paragraph({
                    spacing: { before: 600, after: 400 },
                    children: [new TextRun({ text: "YOUR RECOMMENDED NEXT STEPS", bold: true, size: 28 })]
                }),
                new Paragraph({
                    spacing: { after: 400 },
                ...
                new Paragraph({
                    spacing: { after: 100 },
                    children: [new TextRun({ text: "Paul Thomas Coaching Ltd", bold: true, size: 22 })]
                }),
                new Paragraph({
                    spacing: { after: 100 },
                    children: [new TextRun({ text: "Email: paul@paulthomascoaching.co.uk", size: 22 })]
                }),
                new Paragraph({
                    spacing: { after: 100 },
                    children: [new TextRun({ text: "Phone: +44 7368 621415", size: 22 })]
                }),
                new Paragraph({
                    spacing: { after: 400 },
                    children: [new TextRun({ text: "Website: navigatetransition.co.uk", size: 22 })]
                }),
