...
function generateMotivationRedContent(scores) {
    return `
        ...
        <div class="results-content">
            ...
            <section class="diagnostic-questions" style="background: #fff9e6; padding: 30px; border-radius: 10px; margin: 30px 0; border-left: 5px solid #f39c12;">
                <h2 style="color: #333; margin-bottom: 20px;">📋 Reflection Questions</h2>
                <p style="color: #666; margin-bottom: 25px; line-height: 1.6;">Before our conversation, spend 10 minutes reflecting on these questions. They'll help you understand the source of your motivation constraint.</p>
                
                <div style="background: white; padding: 20px; border-radius: 8px; margin-bottom: 15px;">
                    <p style="font-weight: 600; color: #333; margin-bottom: 10px;">1. When you imagine being in a different role within the same organization, does your energy shift?</p>
                    <p style="color: #666; font-size: 0.95em; margin-left: 20px;">• Yes → This is a role issue, not organizational<br>• No → This is an organizational context issue</p>
                </div>
                
                <div style="background: white; padding: 20px; border-radius: 8px; margin-bottom: 15px;">
                    <p style="font-weight: 600; color: #333; margin-bottom: 10px;">2. When did you last feel genuinely energized by your work?</p>
                    <p style="color: #666; font-size: 0.95em; margin-left: 20px;">Think about whether this is a recent decline or a longer pattern</p>
                </div>
                
                <div style="background: white; padding: 20px; border-radius: 8px; margin-bottom: 15px;">
                    <p style="font-weight: 600; color: #333; margin-bottom: 10px;">3. If this organization underwent fundamental change tomorrow, would you want to stay?</p>
                    <p style="color: #666; font-size: 0.95em; margin-left: 20px;">This tests whether the situation is repairable or irretrievable</p>
                </div>
                
                <div style="background: white; padding: 20px; border-radius: 8px; margin-bottom: 15px;">
                    <p style="font-weight: 600; color: #333; margin-bottom: 10px;">4. Are your high-performing colleagues also experiencing similar exhaustion?</p>
                    <p style="color: #666; font-size: 0.95em; margin-left: 20px;">This helps distinguish individual patterns from systemic toxicity</p>
                </div>
                
                <p style="margin-top: 20px; padding: 15px; background: white; border-radius: 8px; color: #666; font-style: italic;">There are no right or wrong answers. These questions help you locate whether your constraint is individual, role-specific, or organizational.</p>
            </section>
...
function generateLearningRedContent(scores) {
    return `
        ...
        <div class="results-content">
            ...
            <section class="diagnostic-questions" style="background: #e6f7ff; padding: 30px; border-radius: 10px; margin: 30px 0; border-left: 5px solid #00bcd4;">
                <h2 style="color: #333; margin-bottom: 20px;">📋 Reflection Questions</h2>
                <p style="color: #666; margin-bottom: 25px; line-height: 1.6;">Before our conversation, spend 10 minutes reflecting on these questions. They'll help you understand the source of your learning constraint.</p>
                
                <div style="background: white; padding: 20px; border-radius: 8px; margin-bottom: 15px;">
                    <p style="font-weight: 600; color: #333; margin-bottom: 10px;">1. When you think about the skills you need, does it feel overwhelming because there's too much, or because you don't know what to prioritize?</p>
                    <p style="color: #666; font-size: 0.95em; margin-left: 20px;">• Too much → Overwhelm issue, needs breaking down<br>• Don't know what matters → Direction issue, needs clarity</p>
                </div>
                
                <div style="background: white; padding: 20px; border-radius: 8px; margin-bottom: 15px;">
                    <p style="font-weight: 600; color: #333; margin-bottom: 10px;">2. Have you successfully learned difficult new things in other areas of your life (hobbies, technology, parenting)?</p>
                    <p style="color: #666; font-size: 0.95em; margin-left: 20px;">• Yes → Your learning capacity is fine; this is about transition-specific confidence<br>• No → May need to rebuild learning confidence generally</p>
                </div>
                
                <div style="background: white; padding: 20px; border-radius: 8px; margin-bottom: 15px;">
                    <p style="font-weight: 600; color: #333; margin-bottom: 10px;">3. If someone handed you a clear, step-by-step roadmap for this transition, would you feel capable of following it?</p>
                    <p style="color: #666; font-size: 0.95em; margin-left: 20px;">• Yes → You need a pathway, not capability building<br>• No → Genuine skill gaps or confidence issues to address</p>
                </div>
                
                <div style="background: white; padding: 20px; border-radius: 8px; margin-bottom: 15px;">
                    <p style="font-weight: 600; color: #333; margin-bottom: 10px;">4. When you imagine yourself as a beginner again, what feeling comes up strongest?</p>
                    <p style="color: #666; font-size: 0.95em; margin-left: 20px;">• Curiosity/excitement → Good foundation, needs permission to start small<br>• Shame/inadequacy → Identity threat interfering with learning</p>
                </div>
                
                <p style="margin-top: 20px; padding: 15px; background: white; border-radius: 8px; color: #666; font-style: italic;">These questions help you understand whether you need a clearer pathway, confidence building, or permission to be a beginner.</p>
            </section>
...
function generateIdentityRedContent(scores) {
    return `
        ...
        <div class="results-content">
            ...
            <section class="diagnostic-questions" style="background: #fff3e6; padding: 30px; border-radius: 10px; margin: 30px 0; border-left: 5px solid #ff6f00;">
                <h2 style="color: #333; margin-bottom: 20px;">📋 Reflection Questions</h2>
                <p style="color: #666; margin-bottom: 25px; line-height: 1.6;">Before our conversation, spend 10 minutes reflecting on these questions. They'll help you understand the source of your identity constraint.</p>
                
                <div style="background: white; padding: 20px; border-radius: 8px; margin-bottom: 15px;">
                    <p style="font-weight: 600; color: #333; margin-bottom: 10px;">1. When you think about your next role, is the discomfort about losing who you've been, or uncertainty about who you're becoming?</p>
                    <p style="color: #666; font-size: 0.95em; margin-left: 20px;">• Losing who I've been → Grief work needed<br>• Uncertainty about future → Exploration needed</p>
                </div>
                
                <div style="background: white; padding: 20px; border-radius: 8px; margin-bottom: 15px;">
                    <p style="font-weight: 600; color: #333; margin-bottom: 10px;">2. If you introduced yourself at a party without mentioning your job title or organization, what would you say?</p>
                    <p style="color: #666; font-size: 0.95em; margin-left: 20px;">• Can answer easily → Core identity intact, just needs translation<br>• Struggle to answer → Identity fused with institutional role</p>
                </div>
                
                <div style="background: white; padding: 20px; border-radius: 8px; margin-bottom: 15px;">
                    <p style="font-weight: 600; color: #333; margin-bottom: 10px;">3. Do you feel like an imposter in your new direction, or do you feel like the direction itself is wrong for you?</p>
                    <p style="color: #666; font-size: 0.95em; margin-left: 20px;">• Imposter → Confidence issue, your skills DO transfer<br>• Wrong direction → Genuine misalignment with values/strengths</p>
                </div>
                
                <div style="background: white; padding: 20px; border-radius: 8px; margin-bottom: 15px;">
                    <p style="font-weight: 600; color: #333; margin-bottom: 10px;">4. If your closest friend described your core strengths, would those strengths still be true in your new direction?</p>
                    <p style="color: #666; font-size: 0.95em; margin-left: 20px;">• Yes → You're the same person in a different container<br>• Unsure → Need to identify portable vs. context-dependent strengths</p>
                </div>
                
                <p style="margin-top: 20px; padding: 15px; background: white; border-radius: 8px; color: #666; font-style: italic;">These questions help you understand whether you need grief work, exploration, or translation of your existing identity to a new context.</p>
            </section>
