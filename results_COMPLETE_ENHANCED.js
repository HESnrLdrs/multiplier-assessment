                            ...
                            children: [
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ text: "Dimension", bold: true, size: 24, color: "ffffff" })]
                                    })],
                                    width: { size: 25, type: WidthType.PERCENTAGE }
                                }),
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ text: "Score", bold: true, size: 24, color: "ffffff" })]
                                    })],
                                    width: { size: 25, type: WidthType.PERCENTAGE }
                                }),
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ text: "Status", bold: true, size: 24, color: "ffffff" })]
                                    })],
                                    width: { size: 25, type: WidthType.PERCENTAGE }
                                }),
                                new TableCell({
                                    children: [new Paragraph({ 
                                        children: [new TextRun({ text: "Assessment", bold: true, size: 24, color: "ffffff" })]
                                    })],
                                    width: { size: 25, type: WidthType.PERCENTAGE }
                                })
                            ]
